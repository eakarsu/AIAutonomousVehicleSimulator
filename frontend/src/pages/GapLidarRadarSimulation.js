...
// v0 scaffold for: No lidar / radar simulation
// Generated by batch_00 audit. Wire to real API; v0 calls /api/gap-lidar-radar-simulation/run.

export default function LidarRadarSimulationPage() {
  ...
  async function run() {
    ...
    try {
      ...
      const res = await fetch('/api/gap-lidar-radar-simulation/run', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.5rem', fontWeight: 600, marginBottom: '0.5rem' }}>No lidar / radar simulation</h1>
