...
// v0 scaffold for: No live AV-platform integration (Waymo, Cruise, Tesla)
// Generated by batch_00 audit. Wire to real API; v0 calls /api/gap-live-av-platform-integration-waymo/run.

export default function LiveAvPlatformIntegrationWaymoPage() {
  ...
  async function run() {
    ...
    try {
      ...
      const res = await fetch('/api/gap-live-av-platform-integration-waymo/run', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.5rem', fontWeight: 600, marginBottom: '0.5rem' }}>No live AV-platform integration (Waymo, Cruise, Tesla)</h1>
