...
// v0 scaffold for: No traffic / surrounding-vehicle modeling
// Generated by batch_00 audit. Wire to real API; v0 calls /api/gap-traffic-surrounding-vehicle-modeling/run.

export default function TrafficSurroundingVehicleModelingPage() {
  ...
  async function run() {
    ...
    try {
      ...
      const res = await fetch('/api/gap-traffic-surrounding-vehicle-modeling/run', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.5rem', fontWeight: 600, marginBottom: '0.5rem' }}>No traffic / surrounding-vehicle modeling</h1>
