...
// v0 scaffold for: No physics-simulation engine bridge
// Generated by batch_00 audit. Wire to real API; v0 calls /api/gap-physics-simulation-engine-bridge/run.

export default function PhysicsSimulationEngineBridgePage() {
  ...
  async function run() {
    ...
    try {
      ...
      const res = await fetch('/api/gap-physics-simulation-engine-bridge/run', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.5rem', fontWeight: 600, marginBottom: '0.5rem' }}>No physics-simulation engine bridge</h1>
